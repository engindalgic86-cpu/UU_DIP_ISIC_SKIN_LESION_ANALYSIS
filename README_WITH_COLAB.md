...
Üsküdar Üniversitesi Sayısal Görüntü İşleme dersi kapsamında hazırlanmış ISIC cilt lezyonu analizi projesi.
...
├── 📖 README.md                  # Bu dosya
├── 📚 ARKADASLARIM_ICIN.md       # Detaylı kullanım rehberi
│
├── 📁 ISIC/                      # Veri seti
│   ├── melanoma/
│   ├── nevus/
...
Detaylı sorun giderme: [ARKADASLARIM_ICIN.md](ARKADASLARIM_ICIN.md)
